...
function shane_tm_background_animation() {
  "use strict";
  var myMove = 20;
  var height = myMove / jQuery(document).height();
  var width = myMove / jQuery(document).width();
  jQuery("body").on("mousemove", function (e) {
    var pageX = e.pageX - jQuery(document).width() / 2,
      pageY = e.pageY - jQuery(document).height() / 2,
      xCor = width * pageX * -1,
      yCor = height * pageY * -1,
      background = jQuery(".animate_bg");

    background.addClass("transition");
    background.css({
      "background-position":
        "calc( 50% + " + xCor + "px ) calc( 50% + " + yCor + "px )",
    });
...
function shane_tm_scrollable() {
  ...
  var socialHeight =
    jQuery(".shane_tm_sidebar .inner .bottom").outerHeight() + 100;
...
function shane_tm_anchor() {
  ...
  jQuery(
    ".shane_tm_one_page_topbar ul li a,.shane_tm_mobile_menu .dropdown .dropdown_inner ul li a,.shane_tm_sidebar .inner .menu ul li a"
  )
    .off()
    .on("click", function (e) {
      e.stopPropagation();
  ...
  jQuery(".shane_tm_sidebar .inner .menu ul li a")
    .off()
    .on("click", function (e) {
      e.stopPropagation();
      var element = jQuery(this);
...
function shane_tm_nav_bg() {
  ...
  jQuery(window).on("scroll", function () {
    var menu = jQuery(".shane_tm_one_page_topbar");
...
function shane_tm_about_tabs() {
  "use strict";

  var button = jQuery(".shane_tm_one_page_about .right .links ul li a");
  var tabList = jQuery(".shane_tm_one_page_about .content");
...
function shane_tm_kenburn_slider() {
  ...
  jQuery(function () {
    jQuery(
      ".shane_tm_fixed_image .overlay_slider,.shane_tm_leftside .overlay_slider,.shane_tm_one_page_experience .overlay_slider,.shane_tm_sidebar_hero .overlay_slider"
    ).vegas({
      timer: false,
  ...
  jQuery(function () {
    jQuery(".shane_tm_one_page_hero .overlay_slider").vegas({
      timer: false,
      animation: ["kenburnsUp", "kenburnsLeft", "kenburnsRight"],
      delay: 7000,
...
function shane_tm_portfolio() {
  ...
  if (jQuery().isotope) {
    // Needed variables
    var list = jQuery(
      ".shane_tm_works .portfolio_list ul,.shane_tm_one_page_portfolio .portfolio_list ul"
    );
    var filter = jQuery(
      ".shane_tm_works .portfolio_filter ul,.shane_tm_one_page_portfolio .portfolio_filter ul"
    );
